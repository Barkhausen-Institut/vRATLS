...
Module Type RemoteAttestationParamsHeapHash <: SignatureConstraints.
...
End RemoteAttestationParamsHeapHash.

Module Type RemoteAttestationAlgorithmsHeapHash
  (π1 : SignatureParams) (* TBD This is strange. The reason is because our code depends on signature scheme functions. *)
  (π2 : RemoteAttestationParamsHeapHash)
...
End RemoteAttestationAlgorithmsHeapHash.


Module RemoteAttestationHeapSig
  (π1 : SignatureParams)
  (π2 : RemoteAttestationParamsHeapHash)
  (π3 : SignatureAlgorithms π1 π2)
  (π4 : RemoteAttestationAlgorithmsHeapHash π1 π2 π3)
...
Module Type RemoteAttestationAlgorithmsNoHeapSig
  (π1 : SignatureParams) (* TBD This is strange. The reason is because our code depends on signature scheme functions. *)
  ...
  (*
    ...
    It allows to discard one of the arguments and just return the other as message!
   *)
  Parameter Hash : State -> Challenge -> chMessage.
